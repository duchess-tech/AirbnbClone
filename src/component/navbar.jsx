...
import { faBars, faSearch, faToggleOff, faToggleOn, faUserCircle } from '@fortawesome/free-solid-svg-icons'
...
function Navbar(props) {
    ...
    const { Loggedin, showPopup, togglePopup, popupFilter, setPopupFilter } = useContext(Context)
    ...
    return (
        < div className="fixed top-0  border-box left-0 right-0  z-10 bg-white ">
            <div className="w-full lg:hidden block  flex p-2  gap-2 justify-center  lg:mt-3 items-center">
                <div className=' flex gap-3  items-center  rounded-pill h-[55px] border-2 shadow-md w-11/12'>
                    <FontAwesomeIcon icon={faSearch} size="xl" className="ml-4" />
                    <div className=" flex w-[150px]   flex-wrap">
                        <p className="font-bold  text-md">Anywhere</p>
                        <div className="flex text-sm mt-0 font-thin ">
                            <p className="">Any week</p>
                            <span>.</span>
                            <p className="">Add guest</p>

                        </div>
                    </div>
                </div>
                <div>
                    <button className="w-[40px] h-[40px] rounded-full border flex justify-center items-center font-bold " onClick={handleFilter}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ display: "block", color: "black", height: "18px", width: "20px", stroke: "black", overflow: "visible" }}><path d="M7 16H3m26 0H15M29 6h-4m-8 0H3m26 20h-4M7 16a4 4 0 1 0 8 0 4 4 0 0 0-8 0zM17 6a4 4 0 1 0 8 0 4 4 0 0 0-8 0zm0 20a4 4 0 1 0 8 0 4 4 0 0 0-8 0zm0 0H3"></path></svg></button>
            ...
            <div className="hidden lg:block  ">
                ...
                <ul className="py-4 pl-0  flex justify-center items-center space-x-32    border-b-2 ">
                    <li className=" stretch-0  w-[105px]">
                        <div className=" gap-2  h-[40px] lg:block hidden " onClick={handleHome}>
                            <svg ><path style={{
                                fill: "rgb(255,56,92)"
                    ...
                    <li>
                        <div className="  border-2 lg:flex hidden lg:block rounded-pill p-1 shadow-sm">
                            ...
                            <div className="w-8 h-8 rounded-full search-case flex justify-center items-center">
                                <FontAwesomeIcon color='white' icon={faSearch} />
                            </div>
                        </div>
                    </li>
                    <li >
                        <div className="lg:flex gap-2  lg:justify-around lg:items-center  lg:block hidden  ">
                            {Loggedin ? <Link className="text-md" to="/airbnbyourhome">Switch to hoisting</Link> : <Link className="text-md" to="/airbnbyourhome">Airbnb your home</Link>}

                            {/* <div className="border-2 lg:flex items-center justify-center"> */}
                            <svg className=" w-[24px] h-[24px] mt-2" >
            ...
            <div className=" w-full lg:flex  pl-6   lg:pr-9 border-b-2  lg:border-b-0 items-end lg:mt-4  text-[#666666]  ">
                <div className="flex  lg:pl-52 lg:pr-20 pl-[478px]  py-3   justify-evenly   removeScrollbar overflow-auto items-center  " >
                    ...
                    <div className='nav-item cursor-pointer hover:text-black'>
                ...
                <div className="lg:flex gap-3 py-3  hover:text-black">
                    <div className=" lg:block hidden">

                        <div className="w-[100px] h-[40px] flex   text-sm border rounded-lg cursor-pointer   justify-center items-center gap-2" onClick={handleFilter}>
                            <span> Filter </span>
                    ...
                    <div className="w-[220px] h-[40px] gap-3 mt-[-19px] ml-10 lg:ml-0 lg:mt-0 border rounded-lg  flex items-center justify-center text-sm"><span>Display total before taxes</span>
                        <div >
                            {toggle == true ?
                                <FontAwesomeIcon icon={faToggleOn} size="2x" onClick={ontoggle} /> : <FontAwesomeIcon icon={faToggleOff} size="2x" style={{}} onClick={ontoggle} />
                            }
                        </div>

    ...
    return (
        <>
            <div className="guest-search">
                <button className='sm-search'>
                    <div className='sm-search-case'>
            ...
            <div className="learn-nav">
                <h6>
                    Show total prices up front Learn more
                </h6>
            </div>

            <div className="nav border-b">
                <div className="flex ml-20 h-[40px] w-[109px]">
                    <svg ><path style={{
                        fill: "rgb(255,56,92)"
                ...
                <div className="w-[350px] border-2 flex rounded-pill p-1 shadow-sm">

...
function Navbar(props) {
    ...
    return (
        <>
            ...
            <div className="mt-4 border-b-2 lg:flex w-full  hidden lg:block lg:justify-between pb-3 ">
                <div className="lg:flex ml-20 h-[40px] w-[109px] lg:block hidden " onClick={handleHome}>
                    <svg ><path style={{
                        fill: "rgb(255,56,92)"
                ...
                <div className="w-[350px] border-2 lg:flex hidden lg:block rounded-pill p-1 shadow-sm">
                ...
                <div className="lg:flex lg:justify-around lg:items-center mr-20 lg:block hidden  w-[270px]">
            ...
            <div className="lg:px-1 lg:flex   items-center lg:mt-4  text-[#666666]  ">
                ...
                <div className="lg:flex gap-2 lg:block hidden hover:text-black">
                    <div className="w-[100px] h-[50px]  text-sm border rounded-lg cursor-pointer  flex justify-center items-center gap-2" onClick={handleFilter}>
                        <span> Filter </span>
                    ...
                    <div className="w-[250px] h-[50px] gap-3  border rounded-lg  flex items-center justify-center text-sm"><span>Display total before taxes</span> <span><input type="range" className="w-8  cursor-pointer  " /></span></div>

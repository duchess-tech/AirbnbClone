...
function AirbnbYourHome(props) {
    ...
    return (
        <section className='' >
            ...
            <nav className="d-flex lg:justify-between px-4 bg-[#ffffff] fixed pt-3 w-full lg:px-32">
                ...
                <div className="lg:flex lg:items-center  ahmbtncase  hidden lg:block">
                    ...
                    <button className='d-flex justify-content-center align-items-center p-3 '>
                        ...
                        {Loggedin ? <Link to="/become-a-host"> Airbnb setup</Link> : <Link onClick={navigateToBecomeAHost} > Airbnb setup</Link>}
                    </button>
                </div>
            </nav>
            {
            ...
            {showEmailOtp &&
                <ConfirmEmail shouldNavigate={true} />
            }
            {
            ...
            <div>
                <h1 className='text-[60px] text-center pb-10 mt-24'>Airbnb it easily with Airbnb Setup</h1>
                {/* <img src="	https://airbnbclone22.netlify.app/assets/airbnbsetup2-70779489.webp" alt=""></img> */}
                <img className='pb-12' src="https://airbnbclone22.netlify.app/assets/airbnb-setup-a8a3fdf7.webp" alt="" />
            </div>

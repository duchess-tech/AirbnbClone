import { faHome, faHomeAlt, faHouseMedicalCircleExclamation, faSearch } from '@fortawesome/free-solid-svg-icons'
...
function AirbnbYourHome() {
    ...
    const onEarning = (e) => {
        ...
        setrange(newearn)
        if (NumberOfNight >=1 ) {
        setNumberOfNight(NumberOfNight+1)    
        }
        // if (range <;= 1920 && range > 64 ) {
        //     setNumberOfNight(NumberOfNight-1)
        // }
    }
    return (
        <section >
            <nav className="d-flex  justify-between items-center  bg-[#ffffff] fixed pt-3 w-full px-32 ">
                ...
                <div className="d-flex items-center ahmbtncase">
                    ...
                    <button className='d-flex justify-content-center align-items-center p-3 '>
                        ...
                        <Link to="/become-a-host"> Airbnb setup</Link></button>
                </div>
            </nav>
            ...
            <div className='pt-40 flex items-center px-32' >
                <div className='w-2/4 px-[161px] '>
                    ...
                    <p> {NumberOfNight} nights at an estimated $64 a night</p>
                ...
                <div className='w-2/4 border h-[550px] rounded-2xl'>
                </div>
            </div>
            <div>
